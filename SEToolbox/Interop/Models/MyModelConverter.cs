...
//             var model = MyModel.LoadCustomModelData(fileName); // Load the model from the file
//             var modelData = MyModel.LoadCustomModelData(fileName);
//             var materials = modelData["Materials"] as List<Material>;
//             var material = materials[0];
//             if (material is DiffuseMaterial diffuseMaterial)
//             {
//                 var diffuseColor = diffuseMaterial.Brush as SolidColorBrush;
//                 if (diffuseColor != null)
//                 {
//                    material = new DiffuseMaterial(diffuseColor);
//                     myModel.Children.Add(new GeometryModel3D(new MeshGeometry3D(), material));
//                 }
//             }
...
//                     var textureFile = Path.Combine(contentPath, diffuseTextureName);
...
//                     var defaultImage = TexUtil.ImageTextureUtil.CreateImage(Path.Combine(contentPath, meshPart.m_MaterialDesc.MaterialName));
//                     var defaultImageBrush = defaultImage == null ? null : new ImageBrush(defaultImage) { ViewportUnits = BrushMappingMode.Absolute };

//                     //method file
//                     var imageBitmap = TexUtil.ImageTextureUtil.CreateBitmap(textureFile);
//                     var tempFile = Path.Combine(@"C:\temp", Path.GetFileNameWithoutExtension(textureFile) + ".png");
//                     TexUtil.ImageTextureUtil.WriteImage(imageBitmap, tempFile);
...
//                         var diffuseTextureImage = TexUtil.ImageTextureUtil.CreateImage(maskTextureFile, false);
...
//                         var maskTextureImage = TexUtil.ImageTextureUtil.CreateImage(maskTextureFile, false, new TexUtil.MaskPixelEffect());
...
//                         var emissiveTextureImage = TexUtil.ImageTextureUtil.CreateImage(maskTextureFile, false, new TexUtil.EmissivePixelEffect(0));
...
//                     else
//                     {
//                         var diffuseTextureImage = TexUtil.ImageTextureUtil.CreateImage(diffuseTextureFile, true);
//                         var diffuseImageBrush = diffuseTextureImage == null ? null : new ImageBrush(diffuseTextureImage) { ViewportUnits = BrushMappingMode.Absolute };
//                         myMatGroup.Children.Add(new DiffuseMaterial() { Brush = diffuseImageBrush, Color = diffuseColor, AmbientColor = ambient });

//                         var emissiveTextureImage = TexUtil.ImageTextureUtil.CreateImage(diffuseTextureFile, false, new TexUtil.EmissivePixelEffect(0));
//                         var emissiveImageBrush = emissiveTextureImage == null ? null : new ImageBrush(emissiveTextureImage) { ViewportUnits = BrushMappingMode.Absolute };
//                         myMatGroup.Children.Add(new EmissiveMaterial() { Brush = emissiveImageBrush, Color = diffuseColor });
...
//                         var specularTextureImage = TexUtil.ImageTextureUtil.CreateImage(specularTextureFile);
