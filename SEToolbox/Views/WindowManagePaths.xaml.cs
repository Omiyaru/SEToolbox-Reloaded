...
namespace SEToolbox.Views
{
    public partial class WindowManagePaths : Window
    {
       ...
       // public object PathsListBox { get; }
        //public TextBox NewPathTextBox { get; private set; }
        ...
        private void BrowseButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
               NewPathTextBox.Text = dialog.SelectedPath;
            }
        }

        private void AddButton_Click(object sender, RoutedEventArgs e)
        {
            string path = NewPathTextBox.Text.Trim();
        ...
        {
           var selected = PathsListBox.SelectedItems;
            if (selected.Count == 0)
            {
                return;
            }
