   ...
   public class FactionModel : BaseModel
{
       ...
       // private float FactionRelation;
        ...
        public List<MyFactionIconsDefinition> Icons { get => _icons; set => SetProperty(ref _icons, value); }
        public Dictionary<long, MyFaction> Factions { get => _factions; set => SetProperty(ref _factions, value); }
        public Dictionary<long, MyFactionMember> Members { get => _members; set => SetProperty(ref _members, value); }
        public Dictionary<long, MyPlayer> SelectedPlayers { get => _selectedPlayers; set => SetProperty(ref _selectedPlayers, value); }
        public Dictionary<long, MyFactionMember> SelectedMembers { get => _selectedMembers; set => SetProperty(ref _selectedMembers, value); }
        ...
        public string Name { get => _factionName; set => SetProperty(ref _factionName, value, nameof(Name)); }
        public string Tag { get => _tag; set => SetProperty(ref _tag, value, nameof(Tag)); }

        public string FactionTypeString { get => _factionTypeString; set => SetProperty(ref _factionTypeString, value, nameof(FactionTypeString)); }
        public string Description { get => _factionDescription; set => SetProperty(ref _factionDescription, value, nameof(Description)); }
        public string PrivateInfo { get => _privateInfo; set => SetProperty(ref _privateInfo, value, nameof(PrivateInfo)); }
        public WorkshopId? FactionIconWorkshopId { get => _factionIconWorkshopId; set => SetProperty(ref _factionIconWorkshopId, value, nameof(FactionIconWorkshopId)); }
        public string FactionLeader { get => _factionLeader; set => SetProperty(ref _factionLeader, value, nameof(FactionLeader)); }
        public MyStringId? FactionIcon { get => _factionIcon; set => SetProperty(ref _factionIcon, value, nameof(FactionIcon)); }
        public int Score { get => _score; set => SetProperty(ref _score, value, nameof(Score)); }
        public string FactionType { get => _factionType; set => SetProperty(ref _factionType, value, nameof(FactionType)); }
        public long FactionId { get => _factionId; set => SetProperty(ref _factionId, value); }
        public int Balance { get => _balance; set => SetProperty(ref _balance, value, nameof(Balance)); }
        public MyStringId? FactionIconString { get => _factionIconString; set => SetProperty(ref _factionIconString, value, nameof(FactionIconString)); }
        public string FactionPrivateInfo { get => _factionPrivateInfo; set => SetProperty(ref _factionPrivateInfo, value, nameof(FactionPrivateInfo)); }
        public SVector3 FactionColor { get => _factionColor; set => SetProperty(ref _factionColor, value, nameof(FactionColor)); }
        public Vector3 IconColor { get => _iconColor; set => SetProperty(ref _iconColor, value, nameof(IconColor)); }
        public Vector3 CustomColor { get => _customColor; set => SetProperty(ref _customColor, value, nameof(CustomColor)); }
        public long FounderId { get => _founderId; set => SetProperty(ref _founderId, value, nameof(FounderId)); }
        public int MemberCount { get => _memberCount; set => SetProperty(ref _memberCount, value, nameof(MemberCount)); }
        public float ObjectivePercentageCompleted { get => _objectivePercentageCompleted; set => SetProperty(ref _objectivePercentageCompleted, value, nameof(ObjectivePercentageCompleted)); }

        public long Member { get => _member; set { _member = value; SetProperty(ref _member, value, nameof(Member)); } }
        public int FactionIconId { get => _factionIconId; set { _factionIconId = value; SetProperty(ref _factionIconId, value, nameof(FactionIconId)); } }
         public int FactionCount { get => _factionCount; set { _factionCount = value; SetProperty(ref _factionCount, value, nameof(FactionCount)); } }
        public bool IsNpcFaction { get => _isNpcFaction; set => SetProperty(ref _isNpcFaction, value); }
        public MyFaction SelectedFaction { get => _selectedFaction; set => SetProperty(ref _selectedFaction, value, nameof(SelectedFaction)); }
        public MyFactionMember SelectedMember { get => _selectedMember; set => SetProperty(ref _selectedMember, value, nameof(SelectedMember)); }
        public MyFaction Faction { get => _faction; set => SetProperty(ref _faction, value, nameof(Faction)); }
        public IFactionBase SelectedPlayer { get => _selectedPlayer; set => SetProperty(ref _selectedPlayer, value, nameof(SelectedPlayer)); }
        public int Reputation { get => _reputation; set => SetProperty(ref _reputation, value, nameof(Reputation)); }
        public int FactionReputation { get => _factionReputation; set => SetProperty(ref _factionReputation, value, nameof(FactionReputation)); } // holder for when the factions reputation Reputation = FactionReputation
        public int PlayerReputation { get => _playerReputation; set => SetProperty(ref _playerReputation, value, nameof(PlayerReputation)); } //this is a holder for the players reputation   Reputation = PlayerReputation
         public long StationId { get => _stationId; set => SetProperty(ref _stationId, value, nameof(StationId)); }
        public string StationName { get => _stationName; set => SetProperty(ref _stationName, value, nameof(StationName)); }
        public MyStationTypeEnum StationType { get => _stationType; set => SetProperty(ref _stationType, value, nameof(StationType)); }
        public ObservableCollection<MyPlayer> Players { get => _players; set => SetProperty(ref _players, value, nameof(Players)); }
        public bool? IsFactionSelected { get => _isFactionSelected; set => SetProperty(ref _isFactionSelected, value, nameof(IsFactionSelected)); }

        public string Leader { get => _leader; set => SetProperty(ref _leader, value, nameof(Leader)); }
        public string SelectedFactionType { get => _selectedFactionType; set => SetProperty(ref _selectedFactionType, value, nameof(SelectedFactionType)); }
