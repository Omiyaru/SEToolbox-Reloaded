...
//                 if (constructor != null)
//                 {
//                     var message = $"{type.Name} was thrown dynamically.\n\nPlease report this to the developer." + Environment.NewLine + new StackTrace().ToString();
...
//                         }
//                     }
//                     Log.WriteLine(exception as string);
//                     Debug.WriteLine(exception + Environment.NewLine + new StackTrace().ToString());
//                 }
//             }
